...
def generate_launch_description():
    ...
    gz_second_resource_path = AppendEnvironmentVariable(
        name='GZ_SIM_RESOURCE_PATH',
        value=':'.join([
            os.path.join(pkg_hospital, 'worlds'),
            str(Path(pkg_hospital).parent.resolve())
        ])
    )
    ...
    ld.add_action(gz_second_resource_path)
